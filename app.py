...
portfolios, and compare them to benchmarks like **SPY** and **QQQ** using historical
...
- **Sharpe ratio** – return per unit of risk, after subtracting a {rf_rate:.2%} risk-free rate.
- **Max drawdown** – worst peak-to-trough loss over the period.
- **CVaR {int(alpha*100)}%** – average loss on the very bad days (tail risk).
